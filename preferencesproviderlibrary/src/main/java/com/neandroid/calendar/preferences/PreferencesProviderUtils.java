package com.neandroid.calendar.preferences;
...
public class PreferencesProviderUtils {
    ...
    private static Uri buildUri(Context context, int code, String spName, String key, Object value) {
        String authorities = PreferencesUtils.getString(context, PreferencesProvider.AUTHORITIES_SPNAME, PreferencesProvider.AUTHORITIES_KEY);
        Uri uri = null;
